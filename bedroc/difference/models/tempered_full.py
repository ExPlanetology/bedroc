...
:class:`~bedroc.difference.models.tempered_likelihood.TemperedDifferenceModel`, both the labeled
...
class TemperedFullModel(CategoryComparisonBase, CategoryClassifierBase):
    ...
    def build_model(self, prior_alpha: float = 1.0, prior_beta: float = 1.0) -> None:
        ...
        with pm.Model(coords=model_coords) as model:
            ...
            # TemperedDifferenceModel.build_model (see that docstring for why both the training
    ...
    def _build_plot_dict(self, *, title: bool, random_seed: int | None = None) -> dict[str, Any]:
        ...
        See
        :meth:`~bedroc.difference.models.tempered_likelihood.TemperedDifferenceModel._build_plot_dict`
